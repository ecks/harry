...
for i in list(range(2, 12))+list(range(13,20))+list(range(21,31)):
    for j in range(0, 3):
        ...
        while l1 and l2:
          ...
          start_term_index = l1.find("[")
          end_term_index = l1.find("]")
          ...
          start_first_index = l2.find("[")
          end_first_index = l2.find("]")
